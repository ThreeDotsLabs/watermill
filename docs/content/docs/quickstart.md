...
weight = 50
draft = false
bref = "Learn how to use Watermill in your project with a hands-on training."
+++
...
You can quickly get started with a guest account — the instructions are on the training page.
