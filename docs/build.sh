...
declare -a files_to_link=(
    ...
    "message/infrastructure/amqp/pubsub.go"
    "message/infrastructure/amqp/pubsub_publish.go"
    "message/infrastructure/amqp/pubsub_subscribe.go"
    "message/infrastructure/amqp/pubsub_config.go"
