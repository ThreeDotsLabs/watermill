...
{{% render-md %}}
{{% load-snippet-partial file="src-link/_examples/pubsubs/router/main.go" first_line_contains="router.AddHandler(" last_line_contains="structHandler{}.Handler," padding_after="1" %}}
{{% /render-md %}}
